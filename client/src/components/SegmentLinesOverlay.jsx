...
import { Color, Cartesian3, SceneMode, Cartesian2 } from 'cesium'
import React from 'react'
import { getBezierCurvePoints } from '../utils/geometry'

export default function SegmentLinesOverlay({ waypoints, segmentSpeeds, sceneMode, unitSystem = 'metric' }) {
        ...
        if (isCurved) {
          ...
          positions = curvePoints.map(point => {
            ...
            return Cartesian3.fromDegrees(
              point.lng, 
              point.lat, 
              groundHeight + interpolatedHeight
            )
          })
        } else {
